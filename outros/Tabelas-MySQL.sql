...
VALUES('TV SAMSUNG 20 POL', 'TV SAMSUNG 20 POL TELA PLANA', 2000, curdate());
...
INSERT INTO produto(NOME, DESCRICAO, LANCE_MINIMO, DATA_CADASTRO)
VALUES('TV SAMSUNG 22 POL', 'TV SAMSUNG 22 POL TELA PLANA', 2500, curdate());

INSERT INTO LANCE(VALOR, DATA_CRIACAO, PRODUTO_ID) VALUES
(2600, curdate(), LAST_INSERT_ID()),
(2700, curdate(), LAST_INSERT_ID());
